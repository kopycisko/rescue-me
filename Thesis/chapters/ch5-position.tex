...
First test concernes walk with the smartphone hold in hand horizontally and beacons places in $10m$ distances between each other. Figure \ref{fig:tests_case10_walk_10m_raw} depicts signal le
