...
Positioning system as such have to match requirements related to the reliability and robustness, accuracy, power efficiency, installation and maintenance effort and safety.
...
% TODO - present summary as a table
Requirements summary:
* Reliability / robustness
** self powered for 72 hours
** able to work even in case where part of infstratructure got failed
* Installation and maintenance
** Semi-automated methods for monitoring the positioning system status
** Support for positioning infrastructure reperation by avoiding manual system reconfiguration
** Solution should be scallable in order to extend positioning system with the new corridors
** Infrastructure devices should be open for software and internal modules updates and extensions.
* Power efficiency
** Possibly self powered
