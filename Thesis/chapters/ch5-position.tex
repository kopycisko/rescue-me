...
\subsection{Hardware and environmental constratins} % (fold)
...
\subsection{WSN based positioning finding systems} % (fold)
\label{sub:wsn_based_positioning_finding_systems}
...
\section{Position finding basing on localization system and mobile device model}
