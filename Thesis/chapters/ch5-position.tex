...
\end{figure}
 ...
 Test was performed two times: one session was about taking the measures while user was an obstacle in between the smartphone and the beacon (labeled as \textbf{NLOS} on the chart) and the second session was about taking the measures while user was not an obstacle (labeled as \textbf{LOS})
