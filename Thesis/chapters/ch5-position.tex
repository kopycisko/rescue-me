...
where $ d $ is the distance between the receiver and transmitter, $A_0$ is a reference RSSI value measured at $d_0$ distance from the transmitter, $n$ is the signal propagation exponent.
...
During tests there were tested omni directional antennas as they are commonly being in use for Bluetooth technology
